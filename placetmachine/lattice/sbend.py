...
class Sbend():
	...
	_float_params = ["s", "x", "y", "xp", "yp", "roll", "tilt", "length", "synrad", "six_dim", "thin_lens", "e0", "aperture_x", "aperture_y", "aperture_losses", "angle", "E1",
	"E2", "K", "K2", "tilt"]
	...
	def __repr__(self):
		return f"Sbend({self.settings}, {self.girder}, {self.index}, '{self.type}')"

	def __str__(self):
		return f"Sbend({json.dumps(self.settings, indent = 4)})"
