...
class Dipole():
	...
	"""
	parameters = ["name", "s", "x", "y", "xp", "yp", "roll", "length", "synrad", "six_dum", "thin_lens", "e0", "aperture_x", "aperture_y", "aperture_losses", "aperture_shape", "strength_x", "strength_y",
	"hcorrector", "hcorrector_step_size", "vcorrector", "vcorrector_step_size", "tclcall_entrance", "tclcall_exit", "short_range_wake"]
	_float_params = ["s", "x", "y", "xp", "yp", "roll", "length", "synrad", "six_dum", "thin_lens", "e0", "aperture_x", "aperture_y", "aperture_losses", "strength_x", "strength_y", "hcorrector", 
